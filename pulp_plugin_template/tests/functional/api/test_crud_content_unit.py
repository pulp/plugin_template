...
from pulp_plugin_template.tests.functional.utils import gen_plugin_template_remote, skip_if
...
class ContentUnitTestCase(unittest.TestCase):
    ...
    * `Pulp Smash #870 <https://github.com/PulpQE/pulp-smash/issues/870>`_
    ...
    def test_01_create_content_unit(self):
        ...
        self.content_unit.update(self.client.post(PLUGIN_TEMPLATE_CONTENT_PATH, attrs))
    ...
    def test_02_read_content_units(self):
        ...
        page = self.client.get(PLUGIN_TEMPLATE_CONTENT_PATH, params={
