...
from pulp_plugin_template.tests.functional.constants import PLUGIN_TEMPLATE_PUBLISHER_PATH
from pulp_plugin_template.tests.functional.utils import gen_plugin_template_publisher, skip_if
...
class CRUDPublishersTestCase(unittest.TestCase):
    ...
    def test_02_read_publishers(self):
        ...
        page = self.client.get(PLUGIN_TEMPLATE_PUBLISHER_PATH, params={
