# coding=utf-8
"""Tests that CRUD plugin_template remotes."""
...
from pulp_plugin_template.tests.functional.constants import PLUGIN_TEMPLATE_REMOTE_PATH
...
class CRUDRemotesTestCase(unittest.TestCase):
    ...
    def test_01_create_remote(self):
        ...
        type(self).remote = self.client.post(PLUGIN_TEMPLATE_REMOTE_PATH, body)
    ...
    def test_02_create_same_name(self):
        ...
        with self.assertRaises(HTTPError):
            self.client.post(PLUGIN_TEMPLATE_REMOTE_PATH, body)
...
def _gen_verbose_remote():
    ...
    """
    attrs = gen_plugin_template_remote()
    attrs.update({
