...
``$ http POST $BASE_ADDR/pulp/pulp/api/v3/remotes/plugin-template/ name='bar' url='http://some.url/somewhere/'``

.. code:: json

    {
        "_href": "http://localhost:24817/pulp/pulp/api/v3/remotes/plugin-template/1/",
        ...
    }
...
sync with. You are telling pulp to fetch content from the remote and add to the repository::
    ...
    $ http POST $BASE_ADDR/pulp/pulp/api/v3/remotes/plugin-template/1/sync/' repository=http://localhost:24817/pulp/api/v3/repositories/1/
